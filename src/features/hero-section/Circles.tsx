  ...
  return (
    <div className="absolute right-0 z-1 aspect-square h-full translate-x-1/2 lg:top-1/2 lg:right-auto lg:-left-56 lg:z-auto lg:h-auto lg:w-auto lg:translate-x-0 lg:-translate-y-1/2">
      <div className="relative h-full w-full lg:h-150 lg:w-150">
        <div className="absolute inset-0 rounded-full border-34 border-[#FF851B]/60 opacity-0 group-[.visible]:translate-y-0 group-[.visible]:opacity-100 group-[.visible]:transition-opacity group-[.visible]:delay-800 group-[.visible]:duration-400 group-[.visible]:ease-in" />
